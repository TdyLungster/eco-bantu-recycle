...
const DarkFooter = () => {
  ...
  const socialIcons = [{
    icon: Mail,
    href: 'mailto:info@bantuthepeople.co.za',
    label: 'Email'
  }, {
    icon: Phone,
  ...
  const certifications = [{
    icon: Shield,
    text: 'ISO 14001 Certified'
  }, {
    icon: Leaf,
    text: 'Carbon Neutral Operations'
  }, {
    icon: Recycle,
    text: 'Zero Landfill Policy'
  }];
  return <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            once: true
              ...
              <div className="flex space-x-4">
                {socialIcons.map((social, index) => <motion.a key={index} href={social.href} whileHover={{
                scale: 1.1,
                y: -2
              }} whileTap={{
                scale: 0.95
              }} className="w-11 h-11 bg-gray-800/50 hover:bg-gradient-to-br hover:from-green-500 hover:to-emerald-500 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm border border-gray-700/50 hover:border-green-400/50" aria-label={social.label}>
          ...
          delay: 0.3
            ...
            <div>
              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => <motion.li key={index} initial={{
                opacity: 0,
                x: -10
              }} whileInView={{
                opacity: 1,
                ...
                delay: index * 0.05
                    ...
                    <a href={link.href} className="text-gray-400 hover:text-green-400 transition-colors duration-200 text-sm hover:translate-x-1 transform transition-transform">
                      {link.label}
                    </a>
                  </motion.li>)}
              </ul>
